...
var myName: string = "Typescript Test!";
document.write( "数字: number" + "<br />");
var myAge: number = 152;
...
// string values
var employees: string[] = ["Bob", "Sally", "Sam","Tom","Jack"];
